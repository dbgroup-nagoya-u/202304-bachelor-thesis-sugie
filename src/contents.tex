...
\begin{figure}[tb]
  \centering
  \includegraphics{./figures/graph-scan-datasize.pdf}
  \caption{データ数変化時の範囲検索}
  \label{fig:japan}
\end{figure}
\begin{figure}[tb]
  \centering
  \includegraphics{./figures/graph-scan-dimenntion.pdf}
  \caption{次元数変化時の範囲検索}
  \label{fig:japan}
\end{figure}
\begin{figure}[tb]
  \centering
  \includegraphics{./figures/graph-scan-skew.pdf}
  \caption{スキュー変化時の範囲検索}
  \label{fig:japan}
\end{figure}
\begin{figure}[tb]
  \centering
  \includegraphics{./figures/graph-scan-selectivity.pdf}
  \caption{選択率変化時の範囲検索}
  \label{fig:japan}
\end{figure}
